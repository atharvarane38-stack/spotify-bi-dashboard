...
MOOD_CFG = {
    ...
    "Sad": {
        "emoji": "\U0001f622",
        "color": "#509BF5",
        "glow":  "rgba(80,155,245,0.30)",
        "bg":    "rgba(123,97,255,0.06)",
        "border":"rgba(80,155,245,0.35)",
    ...
    for feat, test, label, val, threshold in checks.get(mood, []):
        ...
        if feat_val is not None and test(feat_val):
            tags.append(
                ...
                f'\u2713 {label} <b style="color:#ffffff;">{val}</b>'
                f'<span style="color:#727272;font-weight:400;">&nbsp;({threshold})</span>'
                f'</span>'
            )
    return " ".join(tags)
...
def feature_bar(label: str, value: float, color: str, fmt: str = ".2f") -> str:
    ...
    return (
        ...
        f'<span style="font-size:0.75rem;color:#727272;width:92px;flex-shrink:0;'
        ...
        f'</div>'
        f'<span style="font-size:0.75rem;color:#b3b3b3;width:34px;text-align:right;'
...
">
    ...
    <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:14px;">
        ...
        <div style="flex:1;min-width:0;">
            ...
            <div style="font-size:0.80rem;color:#b3b3b3;margin-top:3px;">{artist}</div>
        </div>
        <!-- popularity -->
        <div style="text-align:center;flex-shrink:0;">
            ...
            <div style="font-size:0.62rem;color:#727272;text-transform:uppercase;
    ...
    <!-- why explainer -->
    <div>
        <div style="font-size:0.68rem;color:#535353;text-transform:uppercase;
...
div[data-testid="stRadio"] > div[role="radiogroup"] > label {
    ...
    font-size:1rem; font-weight:600; color:#b3b3b3;
}
...
div[data-testid="stRadio"] > div[role="radiogroup"] > label:nth-child(2):has(input:checked) {
    border-color:#509BF5aa !important; color:#509BF5 !important;
    background:rgba(80,155,245,0.08) !important;
    box-shadow:0 0 20px rgba(123,97,255,0.15), 0 4px 0 0 #509BF5;
}
...
div[data-testid="stRadio"] > div[role="radiogroup"] > label:nth-child(4):has(input:checked) {
    border-color:#1DB954aa !important; color:#1DB954 !important;
    background:rgba(29,185,84,0.08) !important;
    box-shadow:0 0 20px rgba(0,229,160,0.15), 0 4px 0 0 #1DB954;
}
...
div[data-testid="stDownloadButton"] button {
    background:linear-gradient(135deg,rgba(0,229,160,0.15),rgba(29,185,84,0.08)) !important;
...
div[data-testid="stDownloadButton"] button:hover {
    ...
    box-shadow:0 6px 20px rgba(29,185,84,0.20) !important;
}
@keyframes fadeUp {
...
# ── Mood selector ──────────────────────────────────────────────────────────────
st.html(
    "<h2 style='color:#ffffff;margin-bottom:6px;font-weight:700;'>"
    "\U0001f3a7 Pick Your Mood</h2>"
    "<p style='color:#727272;font-size:0.88rem;margin-top:0;margin-bottom:18px;'>"
...
st.html(
    ...
    ">
        ...
        <div style="font-size:0.84rem;color:#b3b3b3;">{cfg['desc']}</div>
        <div style="font-size:0.78rem;color:#727272;margin-top:8px;">
...
st.html(
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:24px;align-items:center;">
        ...
        ">
            ...
            <div style="font-size:0.70rem;color:#727272;text-transform:uppercase;
        ...
        <div style="
            ...
            border-radius:12px;padding:10px 20px;text-align:center;
        ">
            <div style="font-size:1.4rem;font-weight:800;color:#ffffff;">{playlist_size}</div>
            <div style="font-size:0.70rem;color:#727272;text-transform:uppercase;
...
st.html(
    f"<h3 style='color:#ffffff;font-weight:700;margin-bottom:4px;'>"
...
with info_col:
    st.html(
        """
        <div style="padding:10px 0;font-size:0.82rem;color:#727272;line-height:1.6;">
            ...
            <b style="color:#b3b3b3;">Soundiiz</b> or <b style="color:#b3b3b3;">TuneMyMusic</b>.
        </div>
        """)
...
fig_radar.update_layout(
    polar=dict(
        ...
        radialaxis=dict(
            ...
            tickfont=dict(color="#727272", size=10),
